<template>
	<div id="app" :style="{'grid-template-rows': isNavRoute ? '1fr' : '66px 1fr'}">
		<a-page-header v-if="!isNavRoute" style="background: #3a84f7; color: #ffffff" :title="$router.currentRoute.meta.title || navTitle || '无'"
		 @back="back" />
		<div class="body">
			<keep-alive>
		...
		<div class="bottom-nav" v-if="isNavRoute">
			<img v-if="currRouteName !== 'home'" src="./assets/img/shouye1.png" width="30px" @click="handleRoute('home')" />
			<img v-else src="./assets/img/shouye2.png" width="30px" @click="handleRoute('home')" />
			<!-- <a-icon @click="handleRoute('home')" class="home" type="home" /> -->
			<img v-if="currRouteName !== 'solution'" src="./assets/img/celue1.png" width="30px" @click="handleRoute('solution')" />
			<img v-else src="./assets/img/celue2.png" width="30px" @click="handleRoute('solution')" />
			<!-- <a-icon
        @click="handleRoute('solution')"
        class="solution"
        type="solution"
      /> -->
			<img v-if="currRouteName !== 'my_watchlist'" src="./assets/img/zx1.png" width="30px" @click="handleRoute('my_watchlist')" />
			<img v-else src="./assets/img/zx2.png" width="30px" @click="handleRoute('my_watchlist')" />
			<!-- <a-icon
        @click="handleRoute('my_watchlist')"
        class="my_watchlist"
        type="check-square"
      /> -->
			<img v-if="currRouteName !== 'user'" src="./assets/img/user1.png" width="30px" @click="handleRoute('user')" />
			<img v-else src="./assets/img/user2.png" width="30px" @click="handleRoute('user')" />
			...
			<div :class="['txt','my_watchlist',currRouteName == 'my_watchlist' && 'blue']">
				自选
			</div>
